      ...
      if (b is Error) {
        apps.addLast(
            NestedStatementError(
                ...
                Transition(
                    cfg,
                    dst = Configuration(SequenceOfStatements(), cfg.scope, cfg.memory, true, b.pc)),
                b.pc))
        continue
      }
      when (b.result) {
            ...
            apps.addLast(
                AssertErr(
                    ...
                    Transition(
                        ...
                        dst =
                            Configuration(
                                SequenceOfStatements(), cfg.scope, cfg.memory, error = true, b.pc)),
                    b.pc))
          }
        }
      }
                          ...
                          Transition(
                              ...
                              dst =
                                  Configuration(
                                      ...
                                      And(
                                          cfg.pathConstraint,
                                          And(Not(invar.result), Not(cond.result))))),
...
fun <A> List<List<A>>.multiply(): List<List<A>> {
  ...
  val l = this.first()
  val ll = this.drop(1)
  if (ll.isEmpty()) return l.map { listOf(it) }
        ...
        apps.addLast(
            NestedStatementError(
                ...
                Transition(
                    cfg,
                    dst =
                        Configuration(SequenceOfStatements(), cfg.scope, cfg.memory, true, combPC)),
                combPC))
        continue
      }
      ...
      if (a is Error) {
        apps.addLast(
            NestedStatementError(
                ...
                Transition(
                    cfg,
                    dst = Configuration(SequenceOfStatements(), cfg.scope, cfg.memory, true, a.pc)),
                a.pc))
        continue
      }
      if (!symbolic) {
            ...
            apps.addLast(
                HavocRangeErr(
                    ...
                    Transition(
                        ...
                        dst =
                            Configuration(
                                SequenceOfStatements(), cfg.scope, cfg.memory, true, a.pc)),
                    a.pc))
        else
            apps.addLast(
                HavocOk(
      ...
      listOf(
          FailOk(
              ...
              Transition(
                  ...
                  dst =
                      Configuration(
                          SequenceOfStatements(), cfg.scope, cfg.memory, true, cfg.pathConstraint)),
              cfg.pathConstraint))
